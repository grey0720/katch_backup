        ...
        chatRef.orderBy("time", "asc").onSnapshot(async (snapshot) => {
            ...
            for (const change of changes) {
                if (change.type === "added") {
                    ...
                    //일단 예시용
                    // 여기서부터
                    let phone1 = '01067891234';
                    let phone2 = '01098765432';

                    if(chatuser_phone === phone1){
                        chatuser_phone = phone2;
                        console.log("Phone number :", chatuser_phone);
                    }else if (chatuser_phone === phone2){
                        chatuser_phone = phone1;
                        console.log("Phone number :", chatuser_phone);
                    }else{
                        chatuser_phone = phone1;
                        console.log("Phone number :", chatuser_phone);
